...
<div class="row hero-content">
    <div class="login_container">
        ...
        <div id="google_recaptha">
            ...
            <p1>MLG.GG에 처음이세요?</p1><span class="txt_gojoin"><a href="join">회원가입</a></span>
            <div>
                <h3>간편 로그인</h3>
<%--                네이버--%>
...
<%--                페이스북--%>
                <button type="button" class="btn_fb">
                        ...
                        <a href="/oauth2/authorization/facebook">
                            <img src="https://member.op.gg/icon_facebook_wh.6ab689d7.svg" class="facebook-button__img" width="24" height="24" alt="facebook">
                            페이스북으로 로그인</a>
                    </span>
                </button>
